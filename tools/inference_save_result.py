...
def _load_experiment_args(work_dir,checkpoint,device) :
    ...
    checkpoint_path = checkpoint or os.path.join(work_dir,  'checkpoint.pth')
...
def _save_predictions(preds, dataset, output_dir) :
