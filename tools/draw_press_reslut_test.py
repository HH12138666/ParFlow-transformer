...
dir_name = '2025-12-04-13-05_PredFormer_depth4_Quadruplet_FACTS_sd0.25_dp0.1_ps16_bs10_256_8_32_5e-4_Adamw_cosine_50ep/saved'
...
# ------------------- 选择一个批次进行查看 -------------------
batch_idx = 1  
preds_batch = data_preds[batch_idx]  
trues_batch = data_trues[batch_idx]  
...
#python  /data/huanghui-data/ParFlow-transformer/tools/draw_press_reslut_test.py