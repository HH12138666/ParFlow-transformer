...
log_file_result = '2025-12-23-22-09_PredFormer_depth4_Quadruplet_FACTS_sd0.25_dp0.1_ps16_bs10_256_8_32_5e-4_Adamw_cosine_50ep'
log_file_name = f'train_20251223_220942.log'
...
def main():
    ...
    # 目标文件夹路径
    output_dir = 'result_analyze/excel/'
    # 确保目录存在
